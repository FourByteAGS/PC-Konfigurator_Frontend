                        ...
                        <div className="col-md-8 p-3">
                            ...
                            <div className="card mb-3">
                                <div className="card-header" data-bs-toggle="collapse" data-bs-target="#collapseCase"
                                     style="border-radius: 5px; border-color: lightgrey;">
                                    <div className="row">
                                        <div
                                ...
                                <div className="row">
                                    <div className="col">
                                        <table className="table">
                                            ...
                                            <tr>
                                                <td className="small-text">Prozessor:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Mainboard:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Prozessorkühler:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">RAM:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Grafikkarte:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Datenträger:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Gehäuselüfter:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            <tr>
                                                <td className="small-text">Netzteil:</td>
                                                <td className="small-text">-</td>
                                            </tr>
                                            </tbody>
                                        </table>
